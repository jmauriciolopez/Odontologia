...
export const Odontograma3D: React.FC<Odontograma3DProps> = ({ 
  ...
  return (
    <div className="h-[600px] w-full bg-slate-50 dark:bg-slate-900 rounded-[3rem] overflow-hidden border border-slate-100 dark:border-slate-800 shadow-inner group">
      <Canvas shadows>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 p-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-100 dark:border-slate-800 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-xl">
          <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Click para seleccionar · Scroll para zoom</p>
      </div>
    </div>
  );
};
