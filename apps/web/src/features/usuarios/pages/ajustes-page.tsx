    ...
    >
      <header>
        <motion.div variants={itemVariants} className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Configuración Central</span>
        </motion.div>
        <motion.h1 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {menuItems.map((item, index) => (
          <PremiumCard 
            key={index} 
            delay={0.1 * index}
            className="group cursor-pointer hover:border-blue-500/50 transition-all active:scale-[0.98]"
          ...
          >
            <div className="p-2 space-y-6">
              <div className="flex items-start justify-between">
                ...
                <div className="h-10 w-10 flex items-center justify-center rounded-full bg-slate-50 dark:bg-slate-800 text-slate-300 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                  <ArrowRight size={18} />
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 pt-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
             <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-slate-300">Base de Datos OK</span>
             </div>
             <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-xs font-bold uppercase tracking-widest text-slate-300">Worker remoción OK</span>
             </div>
          </div>
        </div>
