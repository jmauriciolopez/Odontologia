    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative group hidden md:block">
          ...
          <input
            ...
            className="rounded-xl py-2.5 pl-10 pr-4 text-sm font-medium w-96 cursor-pointer outline-none transition-all shadow-sm hover:shadow-md"
            style={{
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="absolute top-2.5 right-2.5 h-1.5 w-1.5 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.5)]" />
        </button>
